...
public class EditProductDialog extends JDialog {
    ...
    public EditProductDialog(JFrame parent, ProductDAO productDAO, Product product) {
    ...
    private void initComponents() {
        ...
        nameField = new JTextField(product.getProductName(), 20);
        ...
        gbc.gridx = 1;
        stockField = new JTextField(String.valueOf(product.getStockQuantity()), 20);
        ...
        gbc.gridx = 1;
        categoryField = new JTextField(String.valueOf(product.getCategoryId()), 20);
